...
public class JdbcPetRepositoryImpl implements PetRepository {
    ...
    public JdbcPetRepositoryImpl(JdbcClient jdbcClient, DataSource dataSource, OwnerRepository ownerRepository) {
        ...
        this.insertPet = new SimpleJdbcInsert(dataSource)
            ...
            .usingColumns("name", "birth_date", "type_id", "owner_id", "microchip_id", "color", "breed", "active", "weight");
    ...
    public void save(Pet pet) {
        if (pet.isNew()) {
            ...
            this.jdbcClient
                .sql("""
                    UPDATE pets
                    SET name=:name, birth_date=:birth_date, type_id=:type_id, owner_id=:owner_id, microchip_id=:microchip_id, color=:color, breed=:breed, active=:active, weight=:weight
                    WHERE id=:id
                    """)
